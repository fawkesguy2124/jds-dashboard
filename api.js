...
// CORE API CALLS
// ============================================================
async function apiCall(action, data = {}, silent = false) {
  ...
  try {
    ...
    if (!silent) showToast('Connection error: ' + err.message, true);
    throw err;
  } finally {
...
// ============================================================
const API = {
  async getJobs(silent=false) {
    return await apiCall('getJobs', {}, silent);
  },
  async getLog(silent=false) {
    return await apiCall('getLog', {}, silent);
  },
  async upsertJob(job) {
